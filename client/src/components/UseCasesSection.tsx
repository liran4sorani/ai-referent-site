...
const USE_CASES = [
  ...
  },
  {
    ...
    chat: [
      { role: "user", text: "מה היסטוריית התביעות של ישראל ישראלי אצל המבטח השנה?" },
      {
        role: "ai",
        text: "📊 תביעות 2024 — ישראל ישראלי:\n\n| טיפול | תאריך | סכום |\n|-------|--------|------|\n| פיזיותרפיה | 15.03 | 1,840 ₪ |\n| אורתופד | 02.05 | 620 ₪ |\n\n💡 סה\"כ נוצל: 2,460 ₪ מתוך 5,000 ₪\n✅ יתרה זמינה: 2,540 ₪",
      },
    ],
  },
];
            ...
            >
              ...
              <div>
                ...
                <div className="flex items-center gap-1">
                  ...
                  <span className="text-white/60 text-xs">מחובר לפורטלי המבטחים</span>
                </div>
              </div>
            </div>
